...
function ValidateHyperVRole
{
    ...
    # Prefer ServerManager/Get-WindowsFeature when available (Windows Server)
    if (Get-Command -Name Get-WindowsFeature -ErrorAction SilentlyContinue)
    {
        ...
        try
        {
            ...
            $Installed = [bool]$hyperv.Installed
        }
        catch
        {
            # Fall through to optional feature checks below
        }
    }

    # Fallback: Get-WindowsOptionalFeature (works on client; also present on many servers)
    if (-not $Installed -and (Get-Command -Name Get-WindowsOptionalFeature -ErrorAction SilentlyContinue))
    {
        $hyperv = Get-WindowsOptionalFeature -Online -FeatureName Microsoft-Hyper-V-All -ErrorAction SilentlyContinue
        if ($hyperv -and $hyperv.State -eq "Enabled") { $Installed = $true }
    ...
    # Last resort: DISM (no PowerShell module dependency)
    if (-not $Installed)
    {
        $dismOut = (dism /online /Get-FeatureInfo /FeatureName:Microsoft-Hyper-V-All 2>$null) -join "`n"
        if ($dismOut -match 'State\s*:\s*Enabled') { $Installed = $true }
    }
    ...
    {
        Log-Error "Hyper-V Role is not enabled (or could not be verified). Exiting..."
        exit 3
    }
}
...
# (Signature content below is intentionally block-commented out to prevent
# parser errors if any lines lose their leading '#', and because edits
# invalidate the original signature anyway.)
# SIG # Begin signature block
...
# LmNvbS9wa2kvY3JsL3Byb2R1Y3RzL01pY1Jvb0NlckF1dDIwMTFfMjAxMS0wNy0w
# OC5jcmwwXgYIKwYBBQUHAQEEUjBQME4GCCsGAQUFBzAChkJodHRwOi8vd3d3Lm1p
# Y3Jvc29mdC5jb20vcGtpL2NlcnRzL01pY1Jvb0NlckF1dDIwMTFfMjAxMV8wM18y
# Mi5jcnQwDAYDVR0TAQH/BAIwADATBgNVHSUEDDAKBggrBgEFBQcDCDANBgkqhkiG
# 9w0BAQsFAAOCAQBTvlVUBivA37PIlXDBx7OKmDODfX54Vg2D4MpnrZwqYPSepOiN
# r7TlS/FqgtN+NCV8rdgO/BhEDT1NgqXVVhrZTXR+DjNEK50NJ2bi5o5gJATjn9ukv
# PZZzrYC9Ts2+Tb6FUgSmh+sfBoR8OtVBA/NB/O89QJkuZZpzgbGALQy3rjEyv2wT
# vEXE7zDl6JtYiS37WNFuf4Xkv/S8DfRnVUpmmDxfmtKjiozjGhQp+s5bHsHghPWY
# zIrd1iM9WQamLOOZQV95irXM1CTszMgE9lx5MtiMRCzXGkcx0zVqvWlD/xdnlhwB
# 4H6HRuSnKFfmRZcjXJBgGPFOj0BIPWrId08oYIS4jCCEt4GCisGAQQBgjcDAwEx
...
# YIZIAWUDBAIBBQAEIADCku66Jykee0L7ZwjfC3hQjQUKIbhq9m18ZoUqCWYXAgZc
